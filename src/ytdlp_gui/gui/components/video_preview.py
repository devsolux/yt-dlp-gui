            ...
            if info and (not info.get('title') or 'youtube video #' in info.get('title', '').lower()):
                ...
                try:
                    ...
                    with yt_dlp.YoutubeDL(alt_opts) as ydl:
                        ...
                        if alt_info and alt_info.get('title') and 'youtube video #' not in alt_info.get('title',
                                                                                                        '').lower():
                            info = alt_info
                except Exception as e:
            ...
            if info and (not info.get('title') or 'youtube video #' in info.get('title', '').lower()):
                ...
                try:
                    ...
                    with yt_dlp.YoutubeDL(minimal_opts) as ydl:
                        ...
                        if min_info and min_info.get('title') and 'youtube video #' not in min_info.get('title',
                                                                                                        '').lower():
                            info = min_info
                except Exception as e:
