...
class CookieManager:
    ...
    @staticmethod
    def _check_chrome_available(system: str) -> bool:
    ...
    @staticmethod
    def _check_firefox_available(system: str) -> bool:
    ...
    @staticmethod
    def _check_edge_available(system: str) -> bool:
    ...
    @staticmethod
    def _check_safari_available() -> bool:
    ...
    @staticmethod
    def _check_chromium_available(system: str) -> bool:
    ...
    @staticmethod
    def _check_opera_available(system: str) -> bool:
    ...
    @staticmethod
    def _get_site_specific_options(url: str) -> Dict[str, Any]:
